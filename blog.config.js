...
const BLOG = {
  ...
  AUTHOR: '邏輯表達力讀書會', // 作者
  BIO: '一群努力實踐的人', // 作者简介
  LINK: 'https://coffee-end-b8a.notion.site/66-dc48103fb511427b92baef7c3754e51f', // 网站地址
  KEYWORDS: 'Notion', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'logicalexpression66@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/logical66', // 你的github个人主页
